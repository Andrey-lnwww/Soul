(() => {
    ...
    (() => {
        ...
        class SelectConstructor {
            ...
            getSelectTitleValue(selectItem, originalSelect) {
                ...
                if (originalSelect.hasAttribute("data-search")) return `<div class="${this.selectClasses.classSelectTitle}"><span${pseudoAttribute} class="${this.selectClasses.classSelectValue}"><input autocomplete="off" type="text" placeholder="${selectTitleValue}" data-placeholder="${selectTitleValue}" class="${this.selectClasses.classSelectInput}"></span></div>`; else {
                    ...
                    return `<button type="button" class="${this.selectClasses.classSelectTitle} btn-reset"><span${pseudoAttribute} class="${this.selectClasses.classSelectValue}${pseudoAttributeClass}"><span class="${this.selectClasses.classSelectContent}${customClass}">${selectTitleValue}</span></span></button>`;
                }
            }
            ...
            getOption(selectOption, originalSelect) {
                ...
                selectOptionHTML += selectOptionLink ? `<a ${selectOptionLinkTarget} ${selectOptionHide} href="${selectOptionLink}" data-value="${selectOption.value}" class="${this.selectClasses.classSelectOption}${selectOptionClass}${selectOptionSelected}">` : `<button ${selectOptionHide} class="${this.selectClasses.classSelectOption}${selectOptionClass}${selectOptionSelected} btn-reset" data-value="${selectOption.value}" type="button">`;
        ...
        da.init();
        function popupPrice(params) {
            const btnOption = document.querySelectorAll(".select__option");
            btnOption.forEach(((item, i) => {
                const btnOptionValue = item.getAttribute("data-value");
                item.addEventListener("click", (e => {
                    const target = e.target;
                    const cost = document.querySelectorAll(".card-popup__price");
                    cost.forEach((item => {
                        let costValueAttribute = item.getAttribute("data-price");
                        if (!target.classList.contains("card-popup__price--active")) {
                            item.classList.remove("card-popup__price--active");
                            if (btnOptionValue == costValueAttribute) item.classList.add("card-popup__price--active");
                        }
                    }));
                }));
            }));
        ...
        const mask_element = document.querySelector(".phone__input");
        const maskOptions = {
